...
function creatureSayCallback(cid, _type, msg)
	...
	elseif Topic[cid] == 1 and msgcontains(msg, 'crocodile') then
		local v = xixi
		selfSay('They are a nuisance! You\'ll find them here in the jungle near the river. Hunt ' .. v.amount[1] .. ' crocodiles and you\'ll get a nice reward. Interested?', cid)
		Topic[cid] = v.storage[1]
