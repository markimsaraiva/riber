local keywordHandler = KeywordHandler:new()
	...
	local travelNode = keywordHandler:addKeyword({'solaris'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Voce deseja ir para solaris?'})
        	travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 0, destination = {x=986, y=769, z=5} })
        	travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Blz, flw!'})
	...
	local travelNode = keywordHandler:addKeyword({'nissey'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Voce deseja ir para nissey?'})
        ...
        local travelNode = keywordHandler:addKeyword({'baiak'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Voce deseja ir para baiak city?'})
        	travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 0, destination = {x=1167, y=1104, z=6} })
        	travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Blz, flw!'})
	...
	local travelNode = keywordHandler:addKeyword({'ancient'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Voce deseja ir para ancient city?'})
        ...
        keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Aqui e: Sarn. Para onde voce quer ir? Para {aracura} , {solaris} , {nissey} , {baiak} city , {ancient} city? '})
