local keywordHandler = KeywordHandler:new()
	...
	local travelNode = keywordHandler:addKeyword({'nissey'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Voce deseja ir para nissey?'})
        ...
        keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Aqui e: Ancient City. Para onde voce quer ir? Para {aracura} , {solaris} , {nissey} , {sarn} , {baiak} city? '})
