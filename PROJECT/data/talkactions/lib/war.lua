War = {
	...
	tempo = { quinze_min = 3,	 	 trinta_min = 5, 	  	 sessenta_min = 8},			--	colocar o nome das variaveis iguais
	preco = { quinze_min = 1, 	 trinta_min = 1,	 sessenta_min = 1},		--  caso fizer alguma alteração
	...
	mapas = {	
						  ...
						  [1] = {     {{x=381,y=572,z=6},{x=383,y=572,z=6}}     },		-- CARLIN
						  [2] = {},
						  [3] = {},
						  [4] = {},
						  [5] = {},
...
function War:new(id, param)
	 ...
	 return setmetatable({
			...
			name = {}
													...
													if Wars[id]== true and Wars[id].aceito == false then 
