...
["TC"] = { x = 1096, y = 1056, z = 7 },
--["Global"] = { x = 1096, y = 1056, z = 7 },
...
-- local coco = { x = 1108, y = 1064, z = 7 }


-- function onThink(cid, interval, lastExecution)
-- if getGlobalStorageValue(13579) not nill then 
-- dosendAnimatedText(coco, " oi ", 200)
 -- getPlayerGuildName(cid)
-- getPlayerGuildId(cid)   getGlobalStorageValue(valueid)
