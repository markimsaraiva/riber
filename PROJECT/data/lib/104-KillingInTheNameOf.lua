...
tasks =
{
	...
	[51] = {killsRequired = 5000, raceName = "Minotaurs", level = {1, 9999}, rank = RANK_JOIN, premium = true, creatures = {"minotaur", "minotaur mage", "minotaur archer"}, rewards = { --Requires an storage (Gained on The Djinn War - Marid Faction)
