...
if item.itemid == 1857 or item.itemid == 1860 or item.itemid == 1863 or item.itemid == 1866 or item.itemid == 1869 or item.itemid == 1872 or item.itemid == 12702 or item.itemid == 12702 or item.itemid == 5616 then  --flat tapestry
...
elseif item.itemid == 1855 or item.itemid == 1858 or item.itemid == 1861 or item.itemid == 1864 or item.itemid == 1867 or item.itemid == 1870 or item.itemid == 12701 or item.itemid == 1 or item.itemid == 5614 then  --south facing
