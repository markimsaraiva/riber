...
piece1pos = {x=1325, y=1271, z=11, stackpos=1}
local tempo = 60*1000 -- tempo para parede voltar
getpiece1 = getThingfromPos(piece1pos)
if item.uid == 2425 and item.itemid == 1945 and getpiece1.itemid == 6289 then
...
elseif item.uid == 2425 and item.itemid == 1946 then
doTransformItem(item.uid,item.itemid-1)
