	...
	fragsToBlackSkull = 9999
	fragsSecondToBlackSkull = 99999
	fragsThirdToBlackSkull = 999999
	...
	-- huntedTopLevel = 50 -- "false" inibe o sistema; numero é o level minimo necessario para dar hunted ao toplvl
	-- priceForEachLevelTohuntedTopLevel = 100 -- preço pago por cada lvl do toplvl ao mata-lo.
