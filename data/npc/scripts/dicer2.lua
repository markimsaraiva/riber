...
local function rollDice(roll, cc_count, pc_count, table_left_pos, table_middle_pos, npc)
	...
	if ((total_g) <= 1000000 and (total_g) >= 5000) then
		...
		doCreatureSay(npc, "Você precisa jogar o dinheiro no meio do depot e falar L para 1 a 3 ou H para 4 a 6 o preço minimo para a aposta é 5k e o maximo 1kk.", TALKTYPE_SAY, false, 0)
	end
	return true
end
