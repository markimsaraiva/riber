...
shopModule:addBuyableItem({'machete'}, 2420, 450, 'machete')
...
shopModule:addBuyableItem({'firebomb'}, 2305, 50, 5, 'firebomb rune')
shopModule:addBuyableItem({'fire field'}, 2301, 50, 5, 'fire field rune')
