...
local msg = {"Digite o nome correto! ex: !addon mage", "Voce não possui Addon Doll!", "Bad param!", "Você recebeu seu addons!"}
local param = string.lower(param)
if (not isPremium(cid)) then
doPlayerSendCancel(cid, "Você nao tem premium account. digite !buypremium")
return TRUE
end
