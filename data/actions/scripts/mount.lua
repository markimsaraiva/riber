...
local exhaust = 100 -- Tempo para player poder usar o item novamente! (tempo em segundos)
...
doCreatureSay(cid, "Yeeeah!!!\nVocê subiu em sua New Montaria.", 19)
...
doPlayerSendCancel(cid, "Desculpe, você só pode usar esse item depois de  "..exhaust.." seconds.")
end
return TRUE
end