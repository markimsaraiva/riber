...
doCreateItem(1025,1,{x=32764, y=32289, z=14})

doCreateItem(1025,1,{x=32764, y=32290, z=14})
...
wall3 = {x=32764, y=32291, z=14, stackpos=1}
...
if item.itemid == 1945 and getwall1.itemid == 1025 then
