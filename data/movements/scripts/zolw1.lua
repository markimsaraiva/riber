...
local thais = {x=32359, y=32901, z=7}
local kurwa = {x=32340, y=32538, z=7}
local kuzwa = {x=32472, y=32869, z=7}
local kita = {x=32415, y=32916, z=7}
local nao = {x=32490, y=32979, z=7}
local anka = {x=32440, y=32971, z=7}
local jano = {x=32523, y=32923, z=7}
local juno = {x=32527, y=32951, z=7}
