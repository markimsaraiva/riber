...
if item.actionid == 14497 and getwall1.itemid == 0 and getwall2.itemid == 0 and getwall3.itemid == 0 and getwall4.itemid == 0 and getwall5.itemid == 0 and getwall6.itemid == 0 and getwall7.itemid == 0 and getwall8.itemid == 0 and getwall9.itemid == 0 and getwall10.itemid == 0 and getwall11.itemid == 0 and getwall12.itemid == 0 and getwall13.itemid == 0 and getwall14.itemid == 0 and getwall15.itemid == 0 and getwall16.itemid == 0 then

doTeleportThing(cid,hss)
else
doPlayerSendTextMessage(cid,MESSAGE_INFO_DESCR, "You need to remove the walls before entering the teleport.")
	end
	return TRUE
end