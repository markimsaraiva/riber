function onStepIn(cid, item, pos)
 ...
 function First() 
    doSummonCreature("Eternal Guardian", {x= 33248,y= 31116,z=7}) 
    ...
    doSummonCreature("Eternal Guardian", {x= 33276,y= 31106,z=7}) 

    doSummonCreature("Lizard Chosen", {x= 33285,y= 31107,z=7}) 
	
	doSummonCreature("Eternal Guardian", {x= 33287,y= 31110,z=7}) 

    doSummonCreature("Lizard Chosen", {x= 33288,y= 31104,z=7}) 

    doSummonCreature("Eternal Guardian", {x= 33284,y= 31115,z=7}) 
    ...
    doSummonCreature("Lizard Chosen", {x= 33266,y= 31128,z=7}) 

    doSummonCreature("Eternal Guardian", {x= 33255,y= 31122,z=7}) 

    doSummonCreature("Lizard Chosen", {x= 33261,y= 31120,z=7}) 
...
function Fourth() --  with 2s delay 
	...
	doSummonCreature("Lizard Gate Guardian", {x= 33261,y= 31100,z=7}) 
...
addEvent(Third, 60000)
addEvent(Fourth, 90000)
addEvent(Teleport, 120000)
